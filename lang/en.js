const en_lang = {
  ...
  // Factura(FT) quick issue page
  quickFactura: {
    pageTitle: 'Factura (FT)',
    userInfo: 'Dados do cliente',
    tabPaymentBill: 'Factura Simplificada',
    tabOtherInvoice: 'Outras facturas',
    ...
    noSelectable: 'Nenhum registo disponível para emissão',
    batchIssueDone: 'Emissão em lote concluída',
    goToPay: 'Ir cobrar',
    stayHere: 'Ficar aqui',
    createSuccessGoPay: 'Factura emitida e impressa. Ir para cobrança?',
  },
  // 其他发票页
  otherInvoices: {
    ...
    agtIssueFail: 'Falha na emissão da fatura',
    ...
    quickActionList: [
      {
        ...
        title: 'Factura',
        tabberName: 'Factura',
        url: '/pages/query-water/quick-factura/index',
      },
      {
        auth: 'R',
        key: '/img/index/icon-business-hall1.png',
        title: 'Factura/Recibo',
        tabberName: 'Factura/Recibo',
        url: '/pages/query-water/other-invoices/index?title_active=1&docType=FR',
      },
      {
        auth: 'R',
      ...
      },
      {
        ...
        title: 'Adiantamento',
        tabberName: 'Factura Automatica',
        url: '/pages/query-water/other-invoices/index?title_active=4&docType=FA',
      },
    ],
  ...
  userWaterInfo: {
    ...
    jfd: 'Ordem de pagamento',
    jmed: 'Limite de redução',
    jfzje: 'Créditos já pagos',
    jfdzje: 'Linha de pagamento pendente',
    qfzje: 'Valor total devido',
    jfdsl: 'Ordem de pagamento',
    zhye: 'Saldo da conta',
    num: 'un',
    wm_name: 'Nome do Cliente',
    wm_no:'Dados do contador',
